...
// Override photo from session if updated
...
<head>
    ...
    <style>
        ...
        .sidebar a.delete-link {
            color: #fff;
            background: #ed4c5aff;
            border: 1px solid #e63946;
        }

        .sidebar a.delete-link:hover {
            background: #ff4d5a;
            border-color: #e6757dff;
            transform: translateX(5px);
        }
    </style>
</head>
<?php if (!empty($_SESSION['notifications'])): ?>
    ...
    <?php // Optional: clear after showing 
    ?>
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <button onclick="if(confirm('Are you sure you want to logout?')) location.href='logout.php';">
                Logout
            </button>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <a href="delete_account.php" class="delete-link">⚠ Delete Account</a>
        ...
        <div class="content-box">
            ...
            <div class="grid">
                ...
                <div class="card" onclick="location.href='change_password.php'">🔐 Security
